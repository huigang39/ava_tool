...
public:
    ...
    static DataType strToDataType(const std::string& str) {
        ...
        if (s == "F32") return DataType::F32;
        if (s == "F64") return DataType::F64;
        if (s == "U8")  return DataType::U8;
        if (s == "U16") return DataType::U16;
        if (s == "U32") return DataType::U32;
        if (s == "U64") return DataType::U64;
        if (s == "I8")  return DataType::I8;
        if (s == "I16") return DataType::I16;
        if (s == "I32") return DataType::I32;
    ...
    static u32 typeBytes(DataType type) {
        switch (type) {
            ...
            case DataType::U16: case DataType::I16: return 2;
            case DataType::F32: case DataType::U32: case DataType::I32: return 4;
            case DataType::F64: case DataType::U64: case DataType::I64: return 8;
            default: return 0;
        }
    }
};
