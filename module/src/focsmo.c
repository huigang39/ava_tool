...
smo_exec(smo_obs_t *smo)
{
        ...
        /* 反电动势估算 */
        lo->est_emf_v_ab.a =
            ABS(lo->est_i_ab_err.a) > cfg->es0 ? CPYSGN(cfg->ks, lo->est_i_ab_err.a) : cfg->ks * lo->est_i_ab_err.a / cfg->es0;

        lo->est_emf_v_ab.b =
            ABS(lo->est_i_ab_err.b) > cfg->es0 ? CPYSGN(cfg->ks, lo->est_i_ab_err.b) : cfg->ks * lo->est_i_ab_err.b / cfg->es0;
